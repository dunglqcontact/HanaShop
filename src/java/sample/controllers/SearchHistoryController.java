        ...
        try {
            ...
            if (currentRole != null) {
                if (currentRole.getRoleName().equals("Customer")) {
                    ...
                    String methodSearch = (String) session.getAttribute("SEARCH_HISTORY_METHOD");
                    ...
                    if (methodSearch.equals("Name")) {
                        ...
                        ArrayList<OrderDTO> orderList = orderDAO.getOrderByName(currentUser.getUserID(), txtSearchProductName);
                        session.setAttribute("ORDER_HISTORY", orderList);
                    } else if (methodSearch.equals("Date")) {
                        String dateString = request.getParameter("cmbDate");
                        ArrayList<OrderDTO> orderList = orderDAO.getOrderByDate(currentUser.getUserID(), dateString);
                        session.setAttribute("ORDER_HISTORY", orderList);
                    }
